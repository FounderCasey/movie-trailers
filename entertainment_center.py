...
# List of movies
this_is_where_i_leave_you = media.Movie("This Is Where I leave You",
                        "A family finally comes together after the passing of the father.",
                        "http://t0.gstatic.com/images?q=tbn:ANd9GcTvx5pCM0lkBYbngKNfZroORVVnYW8iGI_i5atzJdvwCyNddBg0",
...
black_mass = media.Movie("Black Mass",
                         "Whitey Bulger is is on the loose. This mad man is dangerous.",
                         "http://t2.gstatic.com/images?q=tbn:ANd9GcSK3LiV9aI4uMtI91ZJjDM15AazxWB5uKkxV8D04NARj2sJdBOG",
                         "https://www.youtube.com/watch?v=CE3e3hGF2jc",
                         "R",
                         "2h 3m",
                         "September 18, 2015")

attack_the_block = media.Movie("Attack The Block",
                         "London teenagers defend their block from falling aliens.",
                         "http://www.graffitiwithpunctuation.net/wp-content/uploads/2014/11/attackthebloxkposter.jpg",
...
the_hurt_locker = media.Movie("The Hurt Locker",
                         ...
                         "https://resizing.flixster.com/AXN5EcGmOKPYd1fA6wq0ijmIsx4=/800x1200/v1.bTsxMTE3NTc3MztqOzE3MDcyOzIwNDg7ODAwOzEyMDA",
...
zootopia = media.Movie("Zootopia",
                         ...
                         "http://t3.gstatic.com/images?q=tbn:ANd9GcQs5vPjzQ1GGkUi1HTW970HfTpdrhyZu13PPRua_pjKSqoGSSzg",
